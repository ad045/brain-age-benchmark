...
deriv_root = Path("/vol/aimspace/users/dena/Documents/clean_brain_age/brain-age-benchmark/processed_LEMON/mvp3")
# source_info_path_update = {'processing': 'autoreject',
#                            'suffix': 'epo'}

subjects = ['010010']

participants = None #chat

# process_empty_room is always skipped, since EEG not EMG data 

# task_is_rest = True ad

# cov_method = "auto" #chat
# inverse_targets = []
...
eeg_template_montage = None # mne.channels.make_standard_montage("standard_1005")
